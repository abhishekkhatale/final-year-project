    ...
    <div className="min-h-screen bg-white text-black">
      <header className="bg-black text-white py-6 shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center flex-wrap">
            ...
            <Link 
              to="/note" 
              className="text-white font-medium hover:underline transition-all mt-4 sm:mt-0"
            >
              ← Back to Notes
            </Link>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {note.description && (
            <p className="text-lg font-medium mb-4">{note.description}</p>
          )}

          <div
            className="prose prose-lg max-w-none"
            dangerouslySetInnerHTML={{ __html: note.notesText }}
          />
        </div>
      </main>
